<header role="banner" class="navbar navbar-static-top navbar-inverse"  style="background:#006600;">
  <div class="container">
    <div class="navbar-header">
      <a class="navbar-brand brnd" href="index.php"><font color="white">EVERGREEN <sub>ECO CONCEPTS</sub></font></a>
      <button data-toggle="collapse-side" data-target=".side-collapse" data-target-2=".side-collapse-container" type="button" class="navbar-toggle pull-left"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>
    </div>
    <div class="navbar-inverse side-collapse in"  style="background:#006600;">
      <nav role="navigation" class="navbar-collapse" style="background:#006600;">
