  ...
  <body style="  background: url('images/Laura-Ashley-Home-Areca-Palm-Tree-in-Pot.jpg');">
    ...
    <div class="container">
      <div class="">
        <div class="slider">
  			  <div class="item">
  				  <img src="images/P_20151030_112435.jpg" alt="">
  				  <div class="desc">
              ...
              <p class="pull-right"> -Alice Walker</p>
  				  </div>
  			  </div>
  			  <div class="item">
  				  <img src="images/areca/P_20151030_113107.jpg" alt="">
  				  <div class="desc">
  					  <p>"A people without the knowledge of their past history, origin and culture is like a tree without roots."</p>
              <p class="pull-right"> -Marcus Garvey</p>
            </div>
  			   </div>
  		  </div>
        <h1>ECO CONCEPTS</h1>
